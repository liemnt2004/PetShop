...
import com.app.Daos.SanPhamDAO;
import com.app.Entitys.SanPham;
import com.app.Entitys.TonKho;
import com.app.Daos.TonKhoDAO;
...
// SAN PHAM ---- SAN PHAM ---- SAN PHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM
    int index = 0;
    ...
    void edit() {
        try {
            String macd = (String) tblDanhSachSanPham.getValueAt(this.index, 0);
            SanPham modelSP = spDao.selectById(macd);
            TonKho modelTK = tkDao.selectById(macd);
...
// SAN PHAM ---- SAN PHAM ---- SAN PHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM ---- SANPHAM
    ...
    private void cuoiCungSamPham() {
        this.index = tblDanhSachSanPham.getRowCount() - 1;
        this.edit();
    }
    ...
    private void SauSanPham() {
        ...
        if (this.index <= tblDanhSachSanPham.getRowCount() - 1) {
            this.edit();
        } else if (this.index > tblDanhSachSanPham.getRowCount() - 1) {
            this.index = 0;
            this.edit();
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("dd-mm-yyyy   hh-mm-ss");
    ...
    private void tblDanhSachSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhSachSanPhamMouseClicked
        if (evt.getClickCount() == 2) {
            this.index = tblDanhSachSanPham.rowAtPoint(evt.getPoint());
            if (this.index >= 0) {
                this.edit();
            }
        }
    ...
    private void btnDauTienDanhSachSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDauTienDanhSachSanPhamActionPerformed
        ...
        this.edit();    }//GEN-LAST:event_btnDauTienDanhSachSanPhamActionPerformed
    ...
    private void btnCuoiCungDanhSachSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCuoiCungDanhSachSanPhamActionPerformed
        cuoiCungSamPham();
        this.edit();    }//GEN-LAST:event_btnCuoiCungDanhSachSanPhamActionPerformed
    ...
    private void btnTruocDanhSachSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTruocDanhSachSanPhamActionPerformed
        TruocSanPham();
        this.edit();    }//GEN-LAST:event_btnTruocDanhSachSanPhamActionPerformed
    ...
    private void btnSauDanhSachSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSauDanhSachSanPhamActionPerformed
        SauSanPham();
        this.edit();    }//GEN-LAST:event_btnSauDanhSachSanPhamActionPerformed
